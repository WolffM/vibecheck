...
Single-lane finding (below the corroboration gate — one signal, weigh accordingly) · firing: consistency · 5 lanes applicable · anchor `e147b1d50b7a` · deletion candidate (orphaned — zero import fan-in, no declared entry point)
