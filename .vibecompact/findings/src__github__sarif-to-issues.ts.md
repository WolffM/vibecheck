...
### arrival — 88% of 8 commits arrived with no reaching test; largest single-commit arrival 16× the repo median
...
```
vibecheck wontfix|noise|justify "arrival:src/github/sarif-to-issues.ts" --reason "..."
```
