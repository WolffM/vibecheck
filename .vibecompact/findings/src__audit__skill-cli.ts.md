...
Single-lane finding (below the corroboration gate — one signal, weigh accordingly) · firing: deadcode · 6 lanes applicable · anchor `e147b1d50b7a` · deletion candidate (knip: entire file unreferenced)
...
- `bin/cli.js:136` — `runScript("audit/skill-cli.ts", args.slice(1));`
