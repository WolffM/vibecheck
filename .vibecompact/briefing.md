...
Anchor: `e147b1d50b7a` (2026-09-03). Generated with the audit report; findings below are corroborated by ≥2 independent lanes unless marked otherwise.
...
- `src/audit/fleet-report.ts` — deadcode: unconsumed exports (some used internally — un-export, don't delete): findLedgerRepos, OPERATOR_RETRACTION, inferMechanism +4 → `.vibecompact/findings/src__audit__fleet-report.ts.md`
...
- `src/audit/lanes/arrival.ts` — deadcode: unconsumed exports (some used internally — un-export, don't delete): ARRIVAL_MIN_TOUCHES, ARRIVAL_WINDOW_DAYS, isSnapshotFile +4 → `.vibecompact/findings/src__audit__lanes__arrival.ts.md`
...
- `src/audit/lanes/duplication.ts` — deadcode: unconsumed exports (some used internally — un-export, don't delete): DIR_PAIR_MIN_LINES, countCodeLinesInSpan, mergedIntervals +3 → `.vibecompact/findings/src__audit__lanes__duplication.ts.md`
...
- `src/audit/ledger.ts` — size: 504 code lines (tier 1) → `.vibecompact/findings/src__audit__ledger.ts.md`
- `src/tools/tool-registry.ts` — arrival → `.vibecompact/findings/src__tools__tool-registry.ts.md`
- `src/audit/runners/type-coverage.ts` — deadcode: unconsumed exports (some used internally — un-export, don't delete): expandSolutionTsconfig, dependenciesInstalled → `.vibecompact/findings/src__audit__runners__type-coverage.ts.md`
